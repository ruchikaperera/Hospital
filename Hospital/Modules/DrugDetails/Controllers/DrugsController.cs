...
namespace Hospital.Modules.DrugDetails.Controllers
{
    ...
    public class DrugsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Description,Qty,Price,State")] Drug drug)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Description,Qty,Price,State")] Drug drug)
        {
            if (id != drug.ID)
            {
                return NotFound();
