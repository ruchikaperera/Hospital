...
namespace Hospital.Modules.StaffManagement.Controllers
{
    public class RemindersController : Controller
    {
        ...
        public RemindersController(HospitalContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,Date,Topic,Description")] Reminder reminder)
        {
            if (id != reminder.Id)
            {
                return NotFound();
